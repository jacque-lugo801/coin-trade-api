                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td valign="middle" class="talign_left tmedium fnt_15pt" style="color: #1B243E; font-size: 15pt; line-height: 1.2;">
                                            Se ha solicitado una valuación para el siguiente producto:
                                          </td>
                                        </tr>
                                        <tr>
                                          <td height="25" style="font-size: 0; line-height: 0">
                                          ...
                                          <td style="border: 1px solid #eaebff; padding: 15px 10px;">
                                            <table  width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="1"  valign="bottom" class="talign_left tbold fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding-bottom: 5px;">
                                                            Total
                                                            <br>
                                                            (IVA incluido):
                                                        </td>
                                                        <td class="space_col_product" width="15"></td>
                                                        <td colspan="2"  valign="bottom" class="talign_left tmedium fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding-bottom: 5px;">
                                                            $ {{$valuationTotal}} MXN
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tr>
                                          <td valign="middle" class="talign_right tmedium fnt_10pt" style="color: #1B243E; font-size: 10pt; line-height: 1.2;">
                                            *Para ver la información completa de su valuación, visite la sección <span class="tbold">Valuaciones</span> del Panel General de su cuenta.
                                          </td>
                                        </tr>
                                        <tr>
                                          <td height="25" style="font-size: 0; line-height: 0">
                                        ...
                                        <tr>
                                          <td valign="middle" class="talign_left tmedium fnt_15pt" style="color: #1B243E; font-size: 15pt; line-height: 1.2;">
                                            Una vez que se realice y compruebe el pago, se dará una respuesta <span class="tbold">"Favorable"</span> o <span class="tbold">"No Favorable"</span> de está.
                                          </td>
                                        </tr>
                                        <tr>
