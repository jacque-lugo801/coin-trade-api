                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td valign="middle" class="talign_center tbold fnt_20pt" style="color: #C78A37; font-size: 20pt; line-height: 1.75;">
                                            Respuesta a solicitud de valuación
                                          </td>
                                        </tr>
                                        <tr>
                                          <td height="15" style="font-size: 0; line-height: 0">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td valign="middle" class="talign_left tmedium fnt_15pt" style="color: #1B243E; font-size: 15pt; line-height: 1.2;">
                                            Su solicitud de valuación con la siguiente informacion ha sido revisada, y se ha determinado su estado como <span class="tbold">"{{$valuation->valuationStatus->vsta_name}}"</span>.
                                          </td>
                                        </tr>
                                        <tr>
                                          <td height="25" style="font-size: 0; line-height: 0">
                                        ...
                                        <tr>
                                          <td style="border: 1px solid #eaebff; padding: 15px 10px;">
                                            <table  width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    <tr>
                                                        <td colspan="1"  valign="top" class="talign_left tbold fnt_9pt" style="color: #1B243E; font-size: 9pt; line-height: 1.2; padding-bottom: 5px;">
                                                            ID:
                                                        </td>
                                                        <td class="space_col_product" width="15"></td>
                                                        <td colspan="2"  valign="top" class="talign_left tmedium fnt_9pt" style="color: #1B243E; font-size: 9pt; line-height: 1.2; padding-bottom: 5px;">
                                                            {{$product->prod_sku}}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="1"  valign="bottom" class="talign_left tbold fnt_9pt" style="color: #1B243E; font-size: 9pt; line-height: 1.2; padding-bottom: 5px;">
                                                            Total
                                                            <br>
                                                            (IVA incluido):
                                                        </td>
                                                        <td class="space_col_product" width="15"></td>
                                                        <td colspan="2"  valign="bottom" class="talign_left tmedium fnt_9pt" style="color: #1B243E; font-size: 9pt; line-height: 1.2; padding-bottom: 5px;">
                                                            $ {{$valuationTotal}} MXN
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="talign_center">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td valign="top" class="talign_center tbold fnt_9pt" style="color: #1B243E; font-size: 9pt; line-height: 1.2; padding-bottom: 5px;">
                                                                                            Anverso
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td valign="top" class="talign_center">
                                                                                            <img src="{{$message->embed($imageFront)}}" width="85" alt=""/>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        ...
                                                                        <td valign="top" class="talign_center">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td valign="top" class="talign_center">
                                                                                            <img src="{{$message->embed($imageBack)}}" width="85" alt=""/>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
