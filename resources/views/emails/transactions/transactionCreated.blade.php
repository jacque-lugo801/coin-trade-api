                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td valign="middle" class="talign_left tmedium fnt_15pt prelative" style="color: #1B243E; font-size: 15pt; line-height: 1.2;">
                                            <!-- Hola {{$user->usu_name}} {{$user->usu_lastname}},  -->
                                            Hola {{$user->usu_name}},
                                          </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td valign="middle" class="talign_left tmedium fnt_15pt" style="color: #1B243E; font-size: 15pt; line-height: 1.2;">
                                            ¡Gracias por comprar en CoinTrade! A continuación encontrará los detalles de su orden.
                                             <!-- (#{{ $transaction->tran_solicitud}}). -->
                                            <!-- realizada el {{ $transaction->tran_created_date->format('d-M-Y')}}. -->
                                          </td>
                                        </tr>
                                        <tr>
                                          <td height="25" style="font-size: 0; line-height: 0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td colspan="2"  valign="top" class="talign_left tmedium fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding-bottom: 5px;">
                                                            {{$user->usu_name}} {{$user->usu_lastname}}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="space_col_product" width="15"></td>
                                                        <td colspan="2"  valign="top" class="talign_left tmedium fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding-bottom: 5px;">
                                                            {{$transaction->tran_address}}
                                                            <br>
                                                            {{$transaction->transactionCity->cit_nombre}}, {{$transaction->transactionState->sta_name}}
                                                            <br>
                                                            {{$transaction->tran_cp}}
                                                            <br>
                                                            {{$transaction->transactionCountry->coun_name}}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <tr>
                                          <td>
                                            ...
                                            <!-- style="border: 1px solid #eaebff; padding: 15px 10px;" -->
                                                <thead>
                                                    <tr>
                                                        <th colspan="1"  valign="top" class="talign_left tbold fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; background-color: #eaebff; padding: 10px 5px; border-right: 1px solid #ffffff;">
                                                            Nombre Producto
                                                        </th>
                                                        <th colspan="1"  valign="top" class="talign_left tbold fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; background-color: #eaebff; padding: 10px 5px; border-right: 1px solid #ffffff;">
                                                            ID
                                                        ...
                                                        <th colspan="1"  valign="top" class="talign_left tbold fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; background-color: #eaebff; padding: 10px 5px;">
                                                            Total
                                                        </th>
                                                    </tr>
                                                </thead>
                                                ...
                                                @foreach ($transaction->transactionDetail as $detail)
                                                    @php
                                                        $productInfo = json_decode($detail->tdet_prod_info, true);
                                                    @endphp
                                                    <tr>
                                                        <td colspan="1"  valign="top" class="talign_left tmedium fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding: 10px 5px; border: 1px solid #eaebff; border-top: transparent; border-right: transparent;">
                                                            {{ $productInfo['prod_name'] }}
                                                        </td>
                                                        <td colspan="1"  valign="top" class="talign_left tmedium fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding: 10px 5px; border: 1px solid #eaebff; border-top: transparent; border-right: transparent;">
                                                            {{ $productInfo['prod_sku'] }}
                                                        </td>
                                                        <td colspan="1"  valign="top" class="talign_center tmedium fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding: 10px 5px; border: 1px solid #eaebff; border-top: transparent; border-right: transparent;">
                                                            {{ $detail['tdet_quantity'] }}
                                                        </td>
                                                        <td colspan="1"  valign="top" class="talign_left tmedium fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding: 10px 5px; border: 1px solid #eaebff; border-top: transparent; border-right: transparent;">
                                                            <!-- {{ $detail['tdet_subtotal'] }} -->
                                                            ${{ number_format($detail->tdet_subtotal, 2, '.', ',') }}
                                                        </td>
                                                        <td colspan="1"  valign="top" class="talign_left tmedium fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding: 10px 5px; border: 1px solid #eaebff; border-top: transparent;">
                                                            <!-- {{ $detail['tdet_total'] }} -->
                                                            ${{ number_format($detail->tdet_total, 2, '.', ',') }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="4"  valign="top" class="talign_right tbold fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding: 10px;">
                                                            TOTAL
                                                        </td>
                                                        <td colspan="1"  valign="top" class="talign_left tbold fnt_11pt" style="color: #1B243E; font-size: 11pt; line-height: 1.2; padding: 10px 5px;">
                                                            ${{ number_format($transaction->tran_total, 2, '.', ',') }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <tr>
                                          <td valign="middle" class="talign_right tmedium fnt_10pt" style="color: #1B243E; font-size: 10pt; line-height: 1.2;">
                                            *Para ver la información completa de su orden, visite la sección <span class="tbold">Compras</span> del Panel General de su cuenta.
                                          </td>
                                        </tr>
                                        <tr>
                                          <td height="25" style="font-size: 0; line-height: 0">
                                        ...
                                        <tr>
                                          <td valign="middle" class="talign_left tmedium fnt_15pt" style="color: #1B243E; font-size: 15pt; line-height: 1.2;">
                                            Su solicitud será revisada, y se le enviará la información de pago mediante un correo.
                                          </td>
                                        </tr>
                                        <tr>
                                          <td height="15" style="font-size: 0; line-height: 0">
                                        ...
                                        <tr>
                                          <td valign="middle" class="talign_left tmedium fnt_15pt" style="color: #1B243E; font-size: 15pt; line-height: 1.2;">
                                            Una vez que se realice y compruebe el pago, se dará una respuesta y se actualizará el estatus de la misma.
                                             <!-- <span class="tbold">"Favorable"</span> o <span class="tbold">"No Favorable"</span> de está. -->
                                          </td>
                                        </tr>
                                        <tr>
