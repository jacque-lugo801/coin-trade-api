...
CREATE TABLE IF NOT EXISTS `cointrade_db`.`valuations` (
  `val_idValuation` INT NOT NULL AUTO_INCREMENT,
  `val_valuation` LONGTEXT NULL,
  `val_amount` INT NOT NULL,
  `val_total` DOUBLE NOT NULL,
  `val_created_date` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  `val_updated_date` DATETIME NULL,
  `val_certificate` LONGTEXT NULL,
  `prod_idProducto` INT NOT NULL,
  `val_idUserRequester` INT NOT NULL,
  ...
  CONSTRAINT `fk_valuations_products1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_valuations_valuation_status1`
    FOREIGN KEY (`vsta_idStatus`)
...
CREATE TABLE IF NOT EXISTS `cointrade_db`.`payments_status` (
  `pyst_idStatus` INT NOT NULL AUTO_INCREMENT,
  `pyst_name` VARCHAR(100) NOT NULL,
  `pyst_description` VARCHAR(100) NULL,
  PRIMARY KEY (`pyst_idStatus`))
ENGINE = InnoDB;
...
START TRANSACTION;
USE `cointrade_db`;
INSERT INTO `cointrade_db`.`products` (`prod_idProducto`, `prod_sku`, `prod_name`, `prod_description`, `prod_country`, `prod_metal`, `prod_diameter`, `prod_condition`, `prod_date`, `prod_weight`, `prod_minting`, `prod_fineness`, `prod_serie`, `prod_denomination`, `prod_number`, `prod_rating`, `prod_unit_cost`, `prod_commission`, `prod_total`, `prod_stock`, `prod_image_front`, `prod_image_back`, `usu_idUser`, `prod_created_date`, `prod_updated_date`, `prod_isActive`, `prod_idType_product`, `prod_idGroup_product`, `prod_idCategory_product`, `prod_isAuthorized`, `prod_isTerms`, `psts_idStatus`) VALUES (DEFAULT, 'MND1', 'Moneda Francisco I. Madero 20 centavos', '<p>La moneda de Chile de 8 Escudos de Fernando VI, acuñada en 1751, es una pieza de gran valor histórico y numismático. Esta moneda presenta en su anverso el retrato del rey Fernando VI, quien gobernó España y sus colonias durante ese período.</p><p>En el reverso, se puede apreciar el escudo real español con los símbolos de Castilla, León, Aragón y Granada, rodeado por el collar del Toisón de Oro. Esta moneda está acuñada en oro de alta pureza y tiene un diámetro considerable, lo que la convierte en una pieza impresionante y codiciada por los coleccionistas. Con su rica historia y su belleza artística, la moneda de Chile de 8 Escudos de Fernando VI - 1751 J es una verdadera joya numismática.</p>', 'MX', 'Plata', '37', NULL, NULL, '2903', '1751', '1999,9/1000 oro fino', NULL, 'Test', NULL, 0, 8550, 855, 9405, 1, '1710372462-Moneda-Anverso-De_Mexico-Mexico-Moneda_Chile_8_Escudos_Fernando_VI_1751_J-Plata-1751.jpeg', '1710372462-Moneda-Reverso-De_Mexico-Mexico-Moneda_Chile_8_Escudos_Fernando_VI_1751_J-Plata-1751.jpeg', 2, '2024-03-13 23:27:43', '2024-03-13 23:27:43', 1, 1, 3, 16, 1, 1, 1);
INSERT INTO `cointrade_db`.`products` (`prod_idProducto`, `prod_sku`, `prod_name`, `prod_description`, `prod_country`, `prod_metal`, `prod_diameter`, `prod_condition`, `prod_date`, `prod_weight`, `prod_minting`, `prod_fineness`, `prod_serie`, `prod_denomination`, `prod_number`, `prod_rating`, `prod_unit_cost`, `prod_commission`, `prod_total`, `prod_stock`, `prod_image_front`, `prod_image_back`, `usu_idUser`, `prod_created_date`, `prod_updated_date`, `prod_isActive`, `prod_idType_product`, `prod_idGroup_product`, `prod_idCategory_product`, `prod_isAuthorized`, `prod_isTerms`, `psts_idStatus`) VALUES (DEFAULT, 'BLE1', '1 Pound (Commonwealth Bank)', '<p>La moneda de Chile de 8 Escudos de Fernando VI, acuñada en 1751, es una pieza de gran valor histórico y numismático. Esta moneda presenta en su anverso el retrato del rey Fernando VI, quien gobernó España y sus colonias durante ese período.</p><p>En el reverso, se puede apreciar el escudo real español con los símbolos de Castilla, León, Aragón y Granada, rodeado por el collar del Toisón de Oro. Esta moneda está acuñada en oro de alta pureza y tiene un diámetro considerable, lo que la convierte en una pieza impresionante y codiciada por los coleccionistas. Con su rica historia y su belleza artística, la moneda de Chile de 8 Escudos de Fernando VI - 1751 J es una verdadera joya numismática.</p>', 'AU', NULL, NULL, 'Conmemorativo', '20/03/1925', NULL, NULL, NULL, 'YN14522558', NULL, '0264782', 0, 5575, 557.5, 6132.5, 1, '1710372790-Billete-Anverso-Del_Mundo-Australia-Moneda_Chile_8_Escudos_Fernando_VI_1751_J-YN14522558.jpeg', '1710372791-Billete-Reverso-Del_Mundo-Australia-Moneda_Chile_8_Escudos_Fernando_VI_1751_J-YN14522558.jpeg', 2, '2024-03-13 23:33:11', '2024-03-13 23:33:11', 1, 2, 5, NULL, 1, 1, 1);
INSERT INTO `cointrade_db`.`products` (`prod_idProducto`, `prod_sku`, `prod_name`, `prod_description`, `prod_country`, `prod_metal`, `prod_diameter`, `prod_condition`, `prod_date`, `prod_weight`, `prod_minting`, `prod_fineness`, `prod_serie`, `prod_denomination`, `prod_number`, `prod_rating`, `prod_unit_cost`, `prod_commission`, `prod_total`, `prod_stock`, `prod_image_front`, `prod_image_back`, `usu_idUser`, `prod_created_date`, `prod_updated_date`, `prod_isActive`, `prod_idType_product`, `prod_idGroup_product`, `prod_idCategory_product`, `prod_isAuthorized`, `prod_isTerms`, `psts_idStatus`) VALUES (DEFAULT, 'BLE2', 'Billete 2 Pesos 1915-1919', '<p>La moneda de Chile de 8 Escudos de Fernando VI, acuñada en 1751, es una pieza de gran valor histórico y numismático. Esta moneda presenta en su anverso el retrato del rey Fernando VI, quien gobernó España y sus colonias durante ese período.</p><p>En el reverso, se puede apreciar el escudo real español con los símbolos de Castilla, León, Aragón y Granada, rodeado por el collar del Toisón de Oro. Esta moneda está acuñada en oro de alta pureza y tiene un diámetro considerable, lo que la convierte en una pieza impresionante y codiciada por los coleccionistas. Con su rica historia y su belleza artística, la moneda de Chile de 8 Escudos de Fernando VI - 1751 J es una verdadera joya numismática.</p>', 'CL', NULL, NULL, 'Conmemorativo', '20/03/1925', NULL, NULL, NULL, 'YN14522558', NULL, '0264782', 0, 5000, 500, 5500, 1, '1710372865-Billete-Anverso-Del_Mundo-Chile-Billete_Chile_8_Escudos_Fernando_VI_1751_J-YN14522558.jpeg', '1710372866-Billete-Reverso-Del_Mundo-Chile-Billete_Chile_8_Escudos_Fernando_VI_1751_J-YN14522558.jpeg', 2, '2024-03-13 23:34:26', '2024-03-13 23:34:26', 1, 2, 5, NULL, 0, 1, 1);
INSERT INTO `cointrade_db`.`products` (`prod_idProducto`, `prod_sku`, `prod_name`, `prod_description`, `prod_country`, `prod_metal`, `prod_diameter`, `prod_condition`, `prod_date`, `prod_weight`, `prod_minting`, `prod_fineness`, `prod_serie`, `prod_denomination`, `prod_number`, `prod_rating`, `prod_unit_cost`, `prod_commission`, `prod_total`, `prod_stock`, `prod_image_front`, `prod_image_back`, `usu_idUser`, `prod_created_date`, `prod_updated_date`, `prod_isActive`, `prod_idType_product`, `prod_idGroup_product`, `prod_idCategory_product`, `prod_isAuthorized`, `prod_isTerms`, `psts_idStatus`) VALUES (DEFAULT, 'MND2', 'Moneda 1 dolar Estatua de la Libertad', '<p>La moneda de Chile de 8 Escudos de Fernando VI, acuñada en 1751, es una pieza de gran valor histórico y numismático. Esta moneda presenta en su anverso el retrato del rey Fernando VI, quien gobernó España y sus colonias durante ese período.</p><p>En el reverso, se puede apreciar el escudo real español con los símbolos de Castilla, León, Aragón y Granada, rodeado por el collar del Toisón de Oro. Esta moneda está acuñada en oro de alta pureza y tiene un diámetro considerable, lo que la convierte en una pieza impresionante y codiciada por los coleccionistas. Con su rica historia y su belleza artística, la moneda de Chile de 8 Escudos de Fernando VI - 1751 J es una verdadera joya numismática.</p>', 'US', 'Plata', '37', NULL, NULL, '2903', '1751', '1999,9/1000 oro fino', NULL, 'Test', NULL, 0, 5000, 500, 5500, 1, '1710372941-Moneda-Anverso-Del_Mundo-Estados_Unidos_de_America-Moneda_Chile_8_Escudos_Fernando_VI_1751_J-Plata-1751.jpeg', '1710372941-Moneda-Reverso-Del_Mundo-Estados_Unidos_de_America-Moneda_Chile_8_Escudos_Fernando_VI_1751_J-Plata-1751.jpeg', 2, '2024-03-13 23:35:42', '2024-03-13 23:35:42', 1, 1, 1, 1, 0, 1, 1);
...
START TRANSACTION;
USE `cointrade_db`;
INSERT INTO `cointrade_db`.`payments_status` (`pyst_idStatus`, `pyst_name`, `pyst_description`) VALUES (DEFAULT, 'Pagada', NULL);
INSERT INTO `cointrade_db`.`payments_status` (`pyst_idStatus`, `pyst_name`, `pyst_description`) VALUES (DEFAULT, 'Cancelada', NULL);
INSERT INTO `cointrade_db`.`payments_status` (`pyst_idStatus`, `pyst_name`, `pyst_description`) VALUES (DEFAULT, 'No pagada', NULL);
