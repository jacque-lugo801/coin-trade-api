...
-- -----------------------------------------------------
-- Table `cointrade_db`.`valuation_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cointrade_db`.`valuation_type` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `cointrade_db`.`valuation_type` (
  `vtpe_idType` INT NOT NULL AUTO_INCREMENT,
  `vtpe_name` VARCHAR(45) NOT NULL,
  `vtpe_description` VARCHAR(45) NULL,
  PRIMARY KEY (`vtpe_idType`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `cointrade_db`.`valuations` (
  ...
  CONSTRAINT `fk_valuations_valuation_type1`
    ...
    REFERENCES `cointrade_db`.`valuation_type` (`vtpe_idType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Data for table `cointrade_db`.`valuation_type`
-- -----------------------------------------------------
START TRANSACTION;
USE `cointrade_db`;
INSERT INTO `cointrade_db`.`valuation_type` (`vtpe_idType`, `vtpe_name`, `vtpe_description`) VALUES (DEFAULT, 'Favorable', NULL);
INSERT INTO `cointrade_db`.`valuation_type` (`vtpe_idType`, `vtpe_name`, `vtpe_description`) VALUES (DEFAULT, 'No favorable', NULL);
INSERT INTO `cointrade_db`.`valuation_type` (`vtpe_idType`, `vtpe_name`, `vtpe_description`) VALUES (DEFAULT, 'En progreso', NULL);
...
START TRANSACTION;
USE `cointrade_db`;
INSERT INTO `cointrade_db`.`settings` (`set_idSetting`, `set_name`, `set_description`, `set_value`) VALUES (DEFAULT, 'valuation_cost', NULL, '6000');
INSERT INTO `cointrade_db`.`settings` (`set_idSetting`, `set_name`, `set_description`, `set_value`) VALUES (DEFAULT, 'comission_cost', NULL, '5000');
